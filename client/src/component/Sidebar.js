...
const Sidebar = () => {
  ...
  return (
    <div className="flex h-screen">
      ...
      {/* Sidebar */}
      <div className={`bg-white text-black w-64 p-5 shadow-md fixed top-0 left-0 h-full z-40 transform transition-transform duration-300 ease-in-out 
        ${isOpen ? 'translate-x-0' : '-translate-x-full'} md:relative md:translate-x-0 md:block overflow-y-auto`}>
        ...
        <ul className="space-y-6">
          <li
            className={`p-2 rounded-md cursor-pointer ${
              location.pathname === "/dashboard1" ? "bg-blue-500 text-white" : "hover:bg-blue-100"
            }`}
          >
            <Link to="/dashboard1" onClick={() => setIsOpen(false)}>Dashboard</Link>
          </li>
          <li
            className={`p-2 rounded-md cursor-pointer ${
              location.pathname === "/calendar" ? "bg-blue-500 text-white" : "hover:bg-blue-100"
            }`}
          >
          ...
          <li
            className={`p-2 rounded-md cursor-pointer ${
              location.pathname === "/activities" ? "bg-blue-500 text-white" : "hover:bg-blue-100"
            }`}
          >
          ...
          <li
            className={`p-2 rounded-md cursor-pointer ${
              location.pathname === "/focus-timer" ? "bg-blue-500 text-white" : "hover:bg-blue-100"
            }`}
          >
            <Link to="/focus-timer" onClick={() => setIsOpen(false)}>Focus Timer</Link>
          </li>
        </ul>
        ...
        {showMoreOptions && (
          <ul className="mt-4 space-y-4">
            ...
            <li className="p-2 rounded-md bg-blue-100 hover:bg-blue-200 cursor-pointer">
              <Link to="/add-task" onClick={() => setIsOpen(false)}>Add Task</Link>
            </li>
            <li className="p-2 rounded-md bg-blue-100 hover:bg-blue-200 cursor-pointer">
